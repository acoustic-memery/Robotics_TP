...
Motor yeetMtr(10, E_MOTOR_GEARSET_36, false, E_MOTOR_ENCODER_DEGREES);
...
Motor angleMtr(8, E_MOTOR_GEARSET_36, false, E_MOTOR_ENCODER_DEGREES);

ADIAnalogIn lightSensor('b');
ADIAnalogIn limitSwitch('g');
void initialize() {
